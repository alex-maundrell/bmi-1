This is just a simple BMI calculator. Practicing with data types and switching between float, int and str. There will be an improved BMI calculator as I go through my course.
